...
define('BASEPATH'   , IS_LOCAL ? '/didi/' : '____EL BASEPATH EN PRODUCCIÓN___');

// Sal del sistema
define('AUTH_SALT'  , 'DidiFramework<3');

// Puerto y la URL del sitio
define('PORT'       , '8080');
//Agregar el puerto cuando este en produccion
// define('URL'        , IS_LOCAL ? 'http://127.0.0.1:'.PORT.'/didi/' : '___URL EN PRODUCCIÓN___');
define('URL'        , IS_LOCAL ? 'http://127.0.0.1'.'/didi/' : '___URL EN PRODUCCIÓN___');
